  ...
  it("Should set winners", function() {
    ...
    ***********/
    ...
    .then(function(result) {
      ...
      ***********/
      assert.notEqual(result[0], '0x0000000000000000000000000000000000000000', 'Winner is not default address for item 0.')
      /*<CODE HERE>*/
      /**********
      ...
      ***********/
      ...
      HINT:     Default address is '0x0000000000000000000000000000000000000000'
                ...
                Parameters for notEqual : (result, default address , message);
      ***********/
      assert.notEqual(result[1], '0x0000000000000000000000000000000000000000', 'Winner is not default address for item 1.')
                /*<CODE HERE>*/
      /**********
      ...
      ***********/
      ...
      HINT:     Default address is '0x0000000000000000000000000000000000000000'
                ...
                Parameters for notEqual : (result, default address , message);
      ***********/
      assert.notEqual(result[2], '0x0000000000000000000000000000000000000000', 'Winner is not default address for item 2.')
      /*<CODE HERE>*/
    })
  });
});